...
const Registration = () => {
    ...
    if (eventName !== "adizya" && eventName !== "mela" && eventName !== "quizmas" && eventName !== "rewind" && eventName !== "samasya" && eventName !== "weekenders")
        return <EventNotActive />

    else if (eventName === "weekenders")
        return <NeedsNoRegistration />
                ...
                {loading ? (
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="container-registrationform">
                            ...
                            <input type="text" name="name" placeholder="Enter Username" required onChange={handleChange} />

                            <label htmlFor="email"><b>Email</b></label>
                            <input type="email" placeholder="Enter Email" name="email" required onChange={handleChange} />

                            <label htmlFor="college"><b>Institution Name</b></label>
                            <input type="text" placeholder="Enter your school/college name" name="college" required onChange={handleChange} />

                            <label htmlFor="phone"><b>Phone Number</b></label>
                            <div className="phone-inputs">
                                <span className="phone-code">
                                    <select name="phoneCode" required onChange={handleChange}>
