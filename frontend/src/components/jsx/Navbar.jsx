                    ...
                    <div class="header__content--flow">
                        <section class="header-content--left">
                            <a href="#" class="brand-logo">
                                ...
                                />
                                <span class="logo-text">Enquire Quiz Club</span>
                            </a>
                        ...
                        <section class="header-content--right">
                            <nav class="header-nav" role="navigation">
                                <ul class={`nav__list ${isExpanded ? 'expanded' : ''}`} aria-expanded={isExpanded}>
                                    <li class="list-item">
                                    ...
                                    <li class="list-item">
                                        <a class="nav__link" href="/members">Members</a>
                                    </li>
                                    <li class="list-item">
                                        <a class="nav__link" href="/archives">Archives</a>
                                    </li>
                                </ul>
                            </nav>
                        </section>
